...
The product is one folder: `cold-eye`. An agent reads it and writes the critique. That is the install.
...
It runs on what claims to be done. Not for plans still on the table, line editing, or a second paraphrase.
