...
- 2026-09-04: Smell Check on site, docs, README. Home dropped riddle test labels and the extra "not a line editor" heading. Skill page says you, not they.
...
- 2026-08-26: `site:dev` exits with a human line if `filepress` is missing. Short URLs are FilePress path mounts plus `_redirects`.
